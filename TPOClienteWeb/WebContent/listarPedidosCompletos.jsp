...
<% 
	...
	int numPedido;
	String direccion;
	ArrayList<PedidoDTO> pedidosCompletos = (ArrayList<PedidoDTO>)request.getAttribute("pedidosCompletos");
	for (Iterator<PedidoDTO> i = pedidosCompletos.iterator(); i.hasNext();)
	{
		aux = i.next();
...
%>
	<tr>
		...
		<td><%=direccion%></td>
		<td>
			<a href="ControladorWeb?action=solicitarPedido&numPedido=<%=numPedido%>">Solicitar Pedido</a>
		</td>
	</tr>
<% 	} %>
</table>	
