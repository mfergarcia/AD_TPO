...
<table cellspacing="3" cellpadding="3" border="1" width="500">
	<tr>
		<td colspan="4"><b>Lista de Pedidos a Confirmar - Prueba</b></td>
	</tr>
	<tr>
...
%>
	<tr>
		...
		<td><%=direccion%></td>
		<td>
			<a href="ControladorWeb?action=obtenerCtaCte&idCliente=<%=idCliente%>&numPedido=<%=numPedido%>">Ver</a>
		</td>
	</tr>
<% 	} %>
</table>	
